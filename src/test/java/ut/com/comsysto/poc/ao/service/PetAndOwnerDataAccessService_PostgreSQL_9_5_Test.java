...
import ut.com.comsysto.poc.ao.service.jdbc.Dockerized_Postgres_9_5_JdbcConfig;
import ut.com.comsysto.poc.ao.service.seed.DatabaseSeedHelper;

@RunWith(ActiveObjectsJUnitRunner.class)
@Data(PetAndOwnerDataAccessService_PostgreSQL_9_5_Test.DataAccessServiceDatabaseUpdater.class)
@Jdbc(Dockerized_Postgres_9_5_JdbcConfig.class)
@NameConverters
public class PetAndOwnerDataAccessService_PostgreSQL_9_5_Test extends PetAndOwnerDataAccessServiceTest {
    @BeforeClass
    public static void setUpEnv() throws Exception {
        setUpDockerContainer(Dockerized_Postgres_9_5_JdbcConfig.DOCKER_RUN_COMMAND);
        Thread.sleep(8000);
    }
    @AfterClass
    public static void tearDownEnv() throws Exception {
        tearDownDockerContainer(Dockerized_Postgres_9_5_JdbcConfig.DOCKER_GET_ID_COMMAND);
        Thread.sleep(1000);
    }
